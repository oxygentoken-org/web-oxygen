  ...
  return (
    <div className="h-full flex flex-col items-center justify-center p-0">
      <div className="w-full max-w-md mx-auto px-4 flex flex-col items-center gap-2">
        <div className="bg-gradient-to-r from-teal-600 to-teal-700 rounded-xl px-3 py-1.5 mb-1.5">
          <h2 className="text-white font-bold text-sm sm:text-base">#SoyCarbonoNeutral</h2>
        </div>
        ...
        <button className="flex items-center bg-white rounded-xl overflow-hidden hover:opacity-90 transition-all flex-1">
          <div className="bg-white p-2 sm:p-3 flex items-center justify-center">
            <svg className="w-4 h-4 sm:w-5 sm:h-5 text-teal-700" fill="currentColor" viewBox="0 0 24 24">
